...
def method():
	...
	print(f'{Y}[{W}3{Y}] {W}METHOD 3 [\x1b[1;91m Deaad \x1b[1;97m] ')
...
'priority': 'u=1, i',}
			lo = session.post('https://m.facebook.com/login/device-based/validate-pin/async/',data=log_data,headers=header_freefb,proxies=proxs,allow_redirects=False).text
			#print(log_data)
			#print(header_freefb)
